...
class QuestionnaireController extends Controller
{
    public function index()
    {
       $alumni = Auth::user()->alumni;
        ...
        $userAnswers = Tb_User_Answers::where('id_user', Auth::user()->id_user)
    ...
    public function submit(Request $request, $periodeId)
    {
        ...
        $userAnswer = Tb_User_Answers::where('id_user', Auth::user()->id_user)
    ...
    public function results()
    {
        ...
        //     'user_id' => auth(),
        //     'alumni_id' => auth()->alumni->id_alumni ?? 'no_alumni'
        // ]);
