...
Route::middleware(['auth:web', CheckRole::class . ':1'])->get('/alumni/statistics-data', [AdminController::class, 'getStatisticsData']);
Route::middleware(['auth:web', CheckRole::class . ':1'])->get('/alumni/top-companies', [AdminController::class, 'getTopCompanies']);
Route::middleware(['auth:web', CheckRole::class . ':1'])->get('/alumni/top-study-programs', [AdminController::class, 'getTopStudyPrograms']);
...
Route::middleware(['auth:web', CheckRole::class . ':1'])->group(function () {
    ...
    // Import
    // Route::get('/admin/questionnaire/import', [QuetionnaireControlleruestionnaireImportController::class, 'showImportForm'])->name('admin.questionnaire.import.form');
    ...
    // Generate Report
    Route::get('/admin/report', [AdminController::class, 'reportPage'])->name('admin.report.index');
    Route::get('/admin/generate-report', [AdminController::class, 'generateReport'])->name('admin.generate-report');
    Route::get('/admin/generate-report-pdf', [AdminController::class, 'generatePDF'])->name('admin.generate-report.pdf');
    Route::get('/admin/generate-report', [AdminController::class, 'generateReport'])->name('admin.generate-report');
    Route::get('/admin/statistik-partisipasi', [AdminController::class, 'statistikPartisipasi'])->name('admin.statistik.partisipasi');
});
